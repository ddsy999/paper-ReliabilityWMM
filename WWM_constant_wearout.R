...
#### ---------------------------------------------------------------------------
# cov_beta1 / cov_diffbeta1 plots
#### ---------------------------------------------------------------------------




(cov_beta1(df_DHEM)+cov_diffbeta1(df_DHEM))+ plot_annotation(title = expression(DHEM))
(cov_beta1(df_adapDHEM,vline_at=0.97701)+cov_diffbeta1(df_adapDHEM,vline_at=0.97701))+ plot_annotation(title = expression(adapDHEM))
...
t <- seq(0.1, max(df |> filter(event==1) |> pull(time)), length.out = 100)
...
(P1+plot_spacer())+plot_annotation(title = "LFP : Posterior Dominance and Change Points")
